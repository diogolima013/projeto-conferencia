...
async function generateLabels(){
  ...
  // Da transportadora, a etiqueta só mostra o nome (sem endereço completo).
  ...
  for(let i = 1; i <= qty; i++){
    const labelHtml = `
      ...
      <div class="lbl-line">${escapeHtml(destNome)}</div>
      ...
      <div class="lbl-line">${escapeHtml(transpNome)}</div>
    `;
